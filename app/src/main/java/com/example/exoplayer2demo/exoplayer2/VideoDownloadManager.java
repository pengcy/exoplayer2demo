 ...
 */
package com.example.exoplayer2demo.exoplayer2;

import android.content.Context;

import com.example.exoplayer2demo.BuildConfig;
...
public class VideoDownloadManager {
  ...
  private VideoDownloadManager(Context context){
    ...
    userAgent = Util.getUserAgent(context, "ExoPlayer2DownloadManager");
  }
